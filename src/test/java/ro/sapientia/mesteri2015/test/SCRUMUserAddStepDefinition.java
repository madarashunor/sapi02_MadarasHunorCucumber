...
public class SCRUMUserAddStepDefinition {
	...
	public void I_open_the_scrum_tool_add_page() throws Throwable {
		...
		driver.get("http://localhost:8080/user/add");
	}
	...
	@Then("^I should get result \"([^\"]*)\" in users list$")
	public void I_should_get_result_in_stories_list(String expectedResult)
			throws Throwable {
//		WebElement calculatorTextBox = driver.findElement(By.id("user-list"));
//		String result = calculatorTextBox.getText();
//
//		// Verify that result of 2+2 is 4
//		Assert.assertEquals(result, expectedResult);
		
		Assert.assertNotNull(driver.findElement(By.id("user-list")));
